            ...
            >
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wide bg-emerald-100 dark:bg-emerald-950/80 text-emerald-700 dark:text-emerald-300 rounded border border-emerald-300/60 dark:border-emerald-700/60">
                    VIP
                  </span>
                </div>
