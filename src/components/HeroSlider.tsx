...
export const HeroSlider: React.FC = () => {
  ...
  return (
    <section 
      ...
      className="relative rounded-3xl overflow-hidden mb-10 shadow-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-zinc-900 text-white"
    ...
    >
      ...
      {/* Main Content Area */}
      <div className="relative z-10 p-6 sm:p-10 lg:p-12 flex flex-col justify-between min-h-[420px] lg:min-h-[460px]">
        
        {/* Top Badges & Switcher buttons */}
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-2 flex-wrap">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-emerald-500 text-zinc-950 shadow-md shadow-emerald-500/30">
              <Zap className="w-3.5 h-3.5 fill-current" />
              HOT MOD FEATURED
            </span>
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-white/10 backdrop-blur-md border border-white/15 text-white">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" />
              Safe & Verified
            </span>
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-white/10 backdrop-blur-md text-emerald-300">
              {activeApk.version}
            </span>
          </div>
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="flex items-center gap-4">
              <img
                ...
                alt={activeApk.title}
                className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover shadow-xl border-2 border-white/20 shrink-0"
              />
              <div>
                <h2 className="text-2xl sm:text-4xl font-extrabold font-display tracking-tight text-white drop-shadow-md">
                  {activeApk.title}
                </h2>
                <div className="flex items-center gap-3 text-xs sm:text-sm text-zinc-300 mt-1 flex-wrap">
                  ...
                  <span className="flex items-center gap-1 text-amber-400 font-bold">
                    ...
                    {activeApk.rating} ({activeApk.ratingCount.toLocaleString()} votes)
                  </span>
                </div>
              </div>
            </div>

            <p className="text-sm sm:text-base text-zinc-300 line-clamp-2 max-w-2xl">
            ...
            <div className="flex items-center gap-3 pt-2 flex-wrap">
              <button
                ...
                onClick={() => navigateToApk(activeApk, 'download')}
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 hover:from-emerald-400 hover:to-teal-300 text-zinc-950 font-bold text-sm sm:text-base flex items-center gap-2 shadow-lg shadow-emerald-500/25 transform hover:-translate-y-0.5 transition cursor-pointer"
              >
              ...
              <button
                ...
                className="px-5 py-3 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white font-semibold text-sm sm:text-base flex items-center gap-2 transition cursor-pointer"
              >
